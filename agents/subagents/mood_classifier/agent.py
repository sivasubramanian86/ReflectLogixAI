...
class MoodClassifierAgent:
    ...
    def classify_affect(self, text: str) -> Dict[str, Any]:
        ...
        if any(w in lower for w in ["anxious", "panic", "overwhelm", "burnout", "exhausted"]):
            ...
            arousal = 0.85
            stress = 8
            keywords = ["Anxiety", "High Stress", "Burnout Risk"]
            ...
            arousal = 0.65
            stress = 6
            keywords = ["Pressure", "Deadlines", "Urgency"]
            ...
            arousal = 0.35
            stress = 2
            keywords = ["Gratitude", "Appreciation", "Peace"]
            ...
            arousal = 0.75
            stress = 2
            keywords = ["Inspiration", "Breakthrough", "Energy"]
        else:
            primary = "Reflective"
            ...
            arousal = 0.35
            stress = 3
            keywords = ["Mindfulness", "Introspection", "Focus"]
